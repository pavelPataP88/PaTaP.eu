...
Большая фоновая картинка сайта намеренно не опубликована: она не нужна для анализа кода и не содержит данных пользователей. В рабочей папке и на живом сайте она остаётся; при локальной сборке GitHub-копии её отсутствие не мешает проверкам.
