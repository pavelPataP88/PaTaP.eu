...
function createPushSender({dataDir,repo,subject="mailto:admin@patap.eu",fetchImpl=globalThis.fetch,now=()=>Date.now()}={}){
  let keys=null;
  ...
  return {config,send,ensureVapidKeys:()=>ensureVapidKeys(dataDir),vapidJwt};
}

module.exports={createPushSender,ensureVapidKeys,vapidJwt,publicRawFromJwk};
