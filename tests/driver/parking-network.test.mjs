...
test("Parking client wires search live occupancy vehicle fit structured reviews media corrections favorites filters Plan B and map bridge",()=>{
  for(const pattern of [/\/api\/driver\/parking\/search/,/\/occupancy/,/\/favorite/,/\/review/,/\/photos/,/\/corrections/,/\/preferences/,/Plan Б/,/fit\.issues/,/occupancy\.predicted/,/booking\.url/,/certification/,/reservable/,/security:Number/,/quietness:Number/,/На карте/])assert.match(client,pattern);
